...
import com.jefte.estacionmeteorologica.Roles.Rol;
...
public class GUIMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnDatosSensores.setEnabled(false);
        ...
        btnReportesEnVivo.setEnabled(false);
    ...
    private void visibilidadBotones() {
        if (usuario.getId_rol() != 0) {
            this.btnReportesEnVivo.setEnabled(this.gestionRol.obtenerDatos().get(usuario.getId_rol()).isDatosEnVivo());
            this.btnDatosSensores.setEnabled(this.gestionRol.obtenerDatos().get(usuario.getId_rol()).isDatosSensores());
            this.btnReportes.setEnabled(this.gestionRol.obtenerDatos().get(usuario.getId_rol()).isReportes());
    ...
    private void btnRolesActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnRolesActionPerformed
        this.dispose();
        GUIRoles.initGUI(this.usuario);
    }// GEN-LAST:event_btnRolesActionPerformed

    private void btnUsuarioActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnUsuarioActionPerformed
        this.dispose();
        GuiUsuario.initGUI(this.usuario);
    ...
    private void btnDatosSensoresActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDatosSensoresActionPerformed
        this.dispose();
        GUIDatosSensores.initGUI(this.usuario);
    ...
    private void btnSensoresActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSensoresActionPerformed
        this.dispose();
        CrudSensores.initGUI(this.usuario);
